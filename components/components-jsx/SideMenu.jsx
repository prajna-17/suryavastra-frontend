  ...
  return (
    <>
      ...
      <div
        ...
        bg-white p-3 transition-transform duration-300 shadow-2xl
      ...
      >
        ...
        {role === "ADMIN" && (
          <div
            ...
            className="mt-4 flex items-center justify-between bg-[#6b3430] p-4 rounded-xl shadow-sm text-white active:scale-95 transition cursor-pointer"
          >
            <div className="flex items-center gap-3">
              <div
                className="rounded-full bg-white/15 flex items-center justify-center text-[12px] font-bold text-white"
